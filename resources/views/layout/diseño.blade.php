    ...
    <div class="card shadow-lg">
      <div class="card-header pb-0 pt-3 ">
        <div class="float-start">
          <h5 class="mt-3 mb-0">Configuración de diseño</h5>
        </div>
      ...
      <div class="card-body pt-sm-3 pt-0">
        <!-- Sidebar Backgrounds -->
        <div>
          <h6 class="mb-0">Color principal</h6>
        </div>
        ...
        <div class="mt-3">
          ...
          <p class="text-sm">Escoge entre 2 diferentes tipos de menu.</p>
        </div>
        <div class="d-flex">
        ...
        <p class="text-sm d-xl-none d-block mt-2">Tu puedes cambiar este diseño en formato de computadoras.</p>
        <!-- Navbar Fixed -->
        <div class="mt-3">
          <h6 class="mb-0">Menu superior fijado</h6>
        </div>
